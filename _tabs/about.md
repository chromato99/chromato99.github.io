...
- 우수 수료생 표창 / 2023.08.31 / 가천 SW 아카데미
...
**주요내용**
- 한국거래소 IT신사업부 스마트워크시스템팀 근무
- 내부 업무시스템(스마트워크시스템) 운영 관리 업무 수행
...
**수행 역할**: 논문 리뷰 준비 및 발표, 아동 행동 기반의 영상 데이터 수집 및 가공, 기술 보고서 번역 보조<br>
...
**주요내용**: C언어 프로그래밍 스터디, 무박2일 게임잼, [overthewire(bandit)](https://overthewire.org/wargames/bandit/) 문제 풀이, [Olympic_Launchbox 게임](https://github.com/chromato99/Olympic_Launchbox) 개발<br>
**수행한 역할**: 프로그래밍 팀장으로서 [스터디 자료](https://cafe.naver.com/hanulsinpok/330) 준비 및 진행, 동아리 행사 준비 및 운용<br>
